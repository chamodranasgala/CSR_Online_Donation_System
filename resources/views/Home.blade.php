...
.card-img-top2, .card-img-top3, .card-img-top1{
...
style="background-image: url('/images/Screenshot 2019-01-18 at 15.23.28 (1).png')">
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,<br>t is a long established fact that a reader will be distracted by the readable </p>
...
<section id= "about" class="about-section-padding  mt-5">
 ...
 <div class="about-img " >
    ...
    <img src="/images/volunteers-collecting-goods-charity-into-huge-donation-box-donating-coins-into-jar-donation-charity-donation-funds-gift-kind-concept-pinkish-coral-bluevector-isolated-illustration_335657-1387.avif" alt="" class="img-fluid border-dark rounded-right">
 </div>
            </div>
            ...
            <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-1" style="background-color: #97ccfd">
                <div class="about-text">
                    <h2>Why Donate ?</h2>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been <br>the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type <br>and scrambled it to make a type specimen book. It has survived not only five centuries,<br> but also the leap into electronic typesetting, remaining essentially unchang</p>
